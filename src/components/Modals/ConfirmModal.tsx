...
export default class ConfirmModal extends Component {
  ...
  handleClosePress = () => {
    if (this.props.closeClicked) {
      this.props.closeClicked(this.props.item);
    } else if (this.props.changeToggle) {
      this.setModalVisible();
    } else if (this.props.isSwap) {
      this.props.doneClicked(this.props.item);
    } else {
      this.props.cancelClicked(this.props.item);
    }
  }
              ...
              >
                ...
                <View style={{ flexDirection: "row", flex: 1 }}>
                  <Text
                    style={[
                      styles.msgContainer,
                      {
                        top: this.props.title || this.props.onlyMsg? 56 : 24,
                        color: appConsumer.theme.colors.text,
                        fontSize: this.props.messageFontSize ?? 14
                      },
                    ]}
                  >
                    {this.props.message}
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() => this.props.cancelClicked(this.props.item)}
                  >
                    <Text style={[styles.txtBody, { color: "#E9C638" }]}>
