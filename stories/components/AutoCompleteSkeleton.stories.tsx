...
const AutoCompleteSkeleton = (props: any) => (
...
const meta: Meta<typeof AutoCompleteSkeleton> = {
  title: 'Skeletons/AutoCompleteSkeleton',
  component: AutoCompleteSkeleton,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'AutoCompleteSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/AutoCompleteSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof AutoCompleteSkeleton>;
