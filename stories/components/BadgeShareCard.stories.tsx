...
const BadgeShareCard = ({title = 'Badge Share Card'}: any) => (
...
const meta: Meta<typeof BadgeShareCard> = {
  title: 'Cards/BadgeShareCard',
  component: BadgeShareCard,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'Shareable badge achievement card\n\n**Source:** `src/components/Cards/BadgeShareCard.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof BadgeShareCard>;
