...
const CarouselImageSkeleton = (props: any) => (
...
const meta: Meta<typeof CarouselImageSkeleton> = {
  title: 'Skeletons/CarouselImageSkeleton',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'CarouselImageSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/CarouselImageSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof CarouselImageSkeleton>;
