...
const CarouselSkeleton = (props: any) => (
...
const meta: Meta<typeof CarouselSkeleton> = {
  title: 'Skeletons/CarouselSkeleton',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'CarouselSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/CarouselSkeleton.tsx`',
      },
    },
  },
};
