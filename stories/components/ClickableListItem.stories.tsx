...
const ClickableListItem = (props: any) => (
  <div style={{ width: 343 }}>
    <div style={{ fontFamily: 'DM Sans', fontSize: 16, fontWeight: 700, color: '#F8F8F9', marginBottom: 12 }}>Clickable List Item</div>
    {[1,2,3].map((i: number) => (
...
const meta: Meta<typeof ClickableListItem> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'ClickableListItem component from the RecoBee mobile app\n\n**Source:** `src/components/List/ClickableListItem.tsx`',
      },
    },
  },
};
