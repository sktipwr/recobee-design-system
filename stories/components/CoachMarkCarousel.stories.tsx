...
const CoachMarkCarousel = (props: any) => (
  <div style={{ width: 375, padding: '0 16px' }}>
    <div style={{ fontFamily: 'DM Sans', fontSize: 16, fontWeight: 700, color: '#F8F8F9', marginBottom: 12 }}>Coach Mark</div>
...
const meta: Meta<typeof CoachMarkCarousel> = {
  title: 'Carousels/CoachMarkCarousel',
  component: CoachMarkCarousel,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'CoachMarkCarousel component from the RecoBee mobile app\n\n**Source:** `src/components/Carousels/CoachMarkCarousel.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof CoachMarkCarousel>;
