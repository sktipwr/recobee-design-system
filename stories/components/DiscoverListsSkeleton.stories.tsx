...
const DiscoverListsSkeleton = (props: any) => (
...
const meta: Meta<typeof DiscoverListsSkeleton> = {
  title: 'Skeletons/DiscoverListsSkeleton',
  component: DiscoverListsSkeleton,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'DiscoverListsSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/DiscoverListsSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof DiscoverListsSkeleton>;
