...
const HomeCarousel = (props: any) => (
  <div style={{ width: 375, padding: '0 16px' }}>
    <div style={{ fontFamily: 'DM Sans', fontSize: 16, fontWeight: 700, color: '#F8F8F9', marginBottom: 12 }}>Home</div>
...
const meta: Meta<typeof HomeCarousel> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'HomeCarousel component from the RecoBee mobile app\n\n**Source:** `src/components/Carousels/HomeCarousel.tsx`',
      },
    },
  },
};
