...
const InboxCardSkeleton = (props: any) => (
...
const meta: Meta<typeof InboxCardSkeleton> = {
  title: 'Cards/InboxCardSkeleton',
  component: InboxCardSkeleton,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'InboxCardSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Cards/InboxCardSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof InboxCardSkeleton>;
