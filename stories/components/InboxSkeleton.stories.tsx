...
const meta: Meta<typeof InboxSkeleton> = {
  title: 'Skeletons/InboxSkeleton',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'InboxSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/InboxSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof InboxSkeleton>;
