...
const ListCoverPicSkeleton = (props: any) => (
...
const meta: Meta<typeof ListCoverPicSkeleton> = {
  title: 'Skeletons/ListCoverPicSkeleton',
  component: ListCoverPicSkeleton,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'ListCoverPicSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/ListCoverPicSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof ListCoverPicSkeleton>;
