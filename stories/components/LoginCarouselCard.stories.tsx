...
const LoginCarouselCard = (props: any) => (
  <div style={{ width: 375, padding: '0 16px' }}>
    <div style={{ fontFamily: 'DM Sans', fontSize: 16, fontWeight: 700, color: '#F8F8F9', marginBottom: 12 }}>Login Card</div>
...
const meta: Meta<typeof LoginCarouselCard> = {
  title: 'Cards/LoginCarouselCard',
  component: LoginCarouselCard,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'Onboarding carousel slide card\n\n**Source:** `src/components/Cards/LoginCarouselCard.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof LoginCarouselCard>;
