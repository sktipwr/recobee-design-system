...
const LoginCarouselGrid = (props: any) => (
  <div style={{ width: 375, padding: '0 16px' }}>
    <div style={{ fontFamily: 'DM Sans', fontSize: 16, fontWeight: 700, color: '#F8F8F9', marginBottom: 12 }}>Login Grid</div>
...
const meta: Meta<typeof LoginCarouselGrid> = {
  title: 'Carousels/LoginCarouselGrid',
  component: LoginCarouselGrid,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'LoginCarouselGrid component from the RecoBee mobile app\n\n**Source:** `src/components/Carousels/LoginCarouselGrid.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof LoginCarouselGrid>;
