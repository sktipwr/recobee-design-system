...
const MovieDiarySkeleton = (props: any) => (
...
const meta: Meta<typeof MovieDiarySkeleton> = {
  title: 'Skeletons/MovieDiarySkeleton',
  component: MovieDiarySkeleton,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'MovieDiarySkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/MovieDiarySkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof MovieDiarySkeleton>;
