...
const MovieShareCard = ({title = 'Movie Share Card'}: any) => (
...
const meta: Meta<typeof MovieShareCard> = {
  title: 'Cards/MovieShareCard',
  component: MovieShareCard,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'Shareable movie card for social\n\n**Source:** `src/components/Cards/MovieShareCard.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof MovieShareCard>;
