...
const MoviesListSkeleton = (props: any) => (
...
const meta: Meta<typeof MoviesListSkeleton> = {
  title: 'Skeletons/MoviesListSkeleton',
  component: MoviesListSkeleton,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'MoviesListSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/MoviesListSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof MoviesListSkeleton>;
