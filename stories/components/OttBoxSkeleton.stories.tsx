...
const OttBoxSkeleton = (props: any) => (
...
const meta: Meta<typeof OttBoxSkeleton> = {
  title: 'Skeletons/OttBoxSkeleton',
  component: OttBoxSkeleton,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'OttBoxSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/OttBoxSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof OttBoxSkeleton>;
