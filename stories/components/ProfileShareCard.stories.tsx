...
const ProfileShareCard = ({title = 'Profile Share Card'}: any) => (
...
const meta: Meta<typeof ProfileShareCard> = {
  title: 'Cards/ProfileShareCard',
  component: ProfileShareCard,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'Shareable profile card\n\n**Source:** `src/components/Cards/ProfileShareCard.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof ProfileShareCard>;
