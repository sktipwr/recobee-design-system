...
const RatingModal = (props: any) => (
  <div style={{ width: 300, backgroundColor: '#272727', borderRadius: 12, padding: 24 }}>
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
      <span style={{ fontFamily: 'DM Sans', fontSize: 16, fontWeight: 700, color: '#F8F8F9' }}>Rating</span>
      <button style={{ background: 'none', border: 'none', color: '#9E9E9E', cursor: 'pointer', fontSize: 16 }}>✕</button>
    </div>
    <div style={{ fontFamily: 'DM Sans', fontSize: 14, color: '#BDBDBD', lineHeight: '22px', marginBottom: 16 }}>RatingModal component from the RecoBee mobile app</div>
...
const meta: Meta<typeof RatingModal> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'RatingModal component from the RecoBee mobile app\n\n**Source:** `src/components/Modals/RatingModal.tsx`',
      },
    },
  },
};
