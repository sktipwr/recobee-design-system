...
const RecoCarouselCTAs = (props: any) => (
  <div style={{ width: 375, padding: '0 16px' }}>
    <div style={{ fontFamily: 'DM Sans', fontSize: 16, fontWeight: 700, color: '#F8F8F9', marginBottom: 12 }}>Reco C T As</div>
...
const meta: Meta<typeof RecoCarouselCTAs> = {
  title: 'Carousels/RecoCarouselCTAs',
  component: RecoCarouselCTAs,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'RecoCarouselCTAs component from the RecoBee mobile app\n\n**Source:** `src/components/Carousels/RecoCarouselCTAs.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof RecoCarouselCTAs>;
