...
const RecoGeneratorSkeleton = (props: any) => (
...
const meta: Meta<typeof RecoGeneratorSkeleton> = {
  title: 'Skeletons/RecoGeneratorSkeleton',
  component: RecoGeneratorSkeleton,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'RecoGeneratorSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/RecoGeneratorSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof RecoGeneratorSkeleton>;
