...
const SearchSkeleton = (props: any) => (
...
const meta: Meta<typeof SearchSkeleton> = {
  title: 'Skeletons/SearchSkeleton',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'SearchSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/SearchSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof SearchSkeleton>;
