...
const ShortsShareCard = ({title = 'Shorts Share Card'}: any) => (
...
const meta: Meta<typeof ShortsShareCard> = {
  title: 'Cards/ShortsShareCard',
  component: ShortsShareCard,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'Shareable shorts/clips card\n\n**Source:** `src/components/Cards/ShortsShareCard.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof ShortsShareCard>;
