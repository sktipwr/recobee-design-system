...
const ShortsSkeleton = (props: any) => (
...
const meta: Meta<typeof ShortsSkeleton> = {
  title: 'Skeletons/ShortsSkeleton',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'ShortsSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/ShortsSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof ShortsSkeleton>;
