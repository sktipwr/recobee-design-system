...
const SocialFeedSkeleton = (props: any) => (
...
const meta: Meta<typeof SocialFeedSkeleton> = {
  title: 'Skeletons/SocialFeedSkeleton',
  component: SocialFeedSkeleton,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'SocialFeedSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/SocialFeedSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof SocialFeedSkeleton>;
