...
const SurveyCarousel = (props: any) => (
  <div style={{ width: 375, padding: '0 16px' }}>
    <div style={{ fontFamily: 'DM Sans', fontSize: 16, fontWeight: 700, color: '#F8F8F9', marginBottom: 12 }}>Survey</div>
...
const meta: Meta<typeof SurveyCarousel> = {
  title: 'Carousels/SurveyCarousel',
  component: SurveyCarousel,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    ...
    docs: {
      description: {
        component: 'SurveyCarousel component from the RecoBee mobile app\n\n**Source:** `src/components/Carousels/SurveyCarousel.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof SurveyCarousel>;
