...
const VideoCarousel = (props: any) => (
  <div style={{ width: 375, padding: '0 16px' }}>
    <div style={{ fontFamily: 'DM Sans', fontSize: 16, fontWeight: 700, color: '#F8F8F9', marginBottom: 12 }}>Video</div>
...
const meta: Meta<typeof VideoCarousel> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'VideoCarousel component from the RecoBee mobile app\n\n**Source:** `src/components/Carousels/VideoCarousel.tsx`',
      },
    },
  },
};
