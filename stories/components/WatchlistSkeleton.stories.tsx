...
const WatchlistSkeleton = (props: any) => (
...
const meta: Meta<typeof WatchlistSkeleton> = {
  title: 'Skeletons/WatchlistSkeleton',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'WatchlistSkeleton component from the RecoBee mobile app\n\n**Source:** `src/components/Skeletons/WatchlistSkeleton.tsx`',
      },
    },
  },
};
export default meta;
type Story = StoryObj<typeof WatchlistSkeleton>;
